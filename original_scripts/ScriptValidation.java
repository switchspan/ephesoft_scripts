...
public class ScriptValidation implements IJDomScript {
	...
	public Object execute(Document document, String methodName, String documentIdentifier) {
		...
		try {
			// System.out.println("*************  Inside ScriptValidation scripts.");
			// System.out.println("*************  Start execution of the ScriptValidation scripts.");
			// System.out.println("Hello World.");
			// System.out.println("*************  Successfully write the xml file for the ScriptValidation scripts.");
			// System.out.println("*************  End execution of the ScriptValidation scripts.");
		} catch (Exception e) {
